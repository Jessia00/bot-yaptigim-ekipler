...
class globalFunctions {
    ...
    const registerfx = global.registerfx = require('../Functions/registerfx.js');
    const guardfx = global.guardfx = require('../Functions/GuardFx.js');
    const invitefx = global.invitefx = require('../Functions/InviteFx.js');
    const moderationfx = global.moderationfx = require('../Functions/ModerationFx.js');
    ...
    const guard = require('../Projects/Guard/Richard.js');
    const invite = require('../Projects/Invite/Richard.js');
    const moderation = require('../Projects/Moderation/Richard.js');
    const register = require('../Projects/Register/Richard.js');
