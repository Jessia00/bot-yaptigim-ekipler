...
class registerfx {
    ...
    static kayitSil(uye) {
      ...
      uye.setNickname(`Santana Kayıtsız`).catch();
    
    }   
    static kayitEt(uye, yetkili, cinsiyet, isim) {
      if(cinsiyet === "erkek") {
        ...
        uye.roles.add(registerConfig.erkek1)
        uye.roles.add(registerConfig.erkek2)
        uye.roles.add(registerConfig.erkek2)
        ...
        uye.roles.add(registerConfig.kadin1)
        uye.roles.add(registerConfig.kadin2)
        uye.roles.add(registerConfig.kadin2)
        if (uye.user.username.includes(settings.tag) && !uye.roles.cache.has(registerConfig.family)) {
          uye.roles.add(registerConfig.family);
          uye.roles.add(registerConfig.family);
