...
module.exports.execute = async(client , message, args) => {
    ...
    const filter = (reaction, user) => {
        ...
        message.channel.send(scaryemb.setDescription(`${victim}, ${message.author} adlı üye senin sesli kanalına girmek istiyor, kabul ediyor musun?`).setFooter(`Kabul etmek için 15 saniyen bulunuyor.`)).then(x => {
