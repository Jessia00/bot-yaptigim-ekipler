...
//////////////////
await user.ban({reason: "SUNUCUYU DÜZENLEDİ"})
await guardFunctions.closeall(curGuild.guild, ["ADMINISTRATOR", "BAN_MEMBERS", "MANAGE_CHANNELS", "KICK_MEMBERS", "MANAGE_GUILD", "MANAGE_WEBHOOKS", "MANAGE_ROLES"]);
