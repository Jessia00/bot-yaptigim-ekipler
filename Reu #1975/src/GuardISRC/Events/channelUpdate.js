...
//////////////////
await user.ban({reason: "KANAL DÜZENLEDİ"})
await guardFunctions.closeall(newChannel.guild, ["ADMINISTRATOR", "BAN_MEMBERS", "MANAGE_CHANNELS", "KICK_MEMBERS", "MANAGE_GUILD", "MANAGE_WEBHOOKS", "MANAGE_ROLES"]);
