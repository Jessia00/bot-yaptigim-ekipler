...
module.exports.execute = async(ModerationClient , message, args) => {
    ...
    moderationFunctions.embedBasari(message.author,message.channel,"Kanal kilitlendi!")
    } else {
    permObjesi["SEND_MESSAGES"] = null;
    message.channel.createOverwrite(everyone, permObjesi);
    message.react(emojis.onay);
    moderationFunctions.embedBasari(message.author,message.channel,"Kanal kilidi açıldı!")
    };
      };
