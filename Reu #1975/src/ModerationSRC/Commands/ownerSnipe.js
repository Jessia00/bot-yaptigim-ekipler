...
if (!message.member.hasPermission("ADMINISTRATOR")) return;
  ...
  if(!data) return message.react(emojis.hata);
  moderationFunctions.embedOlustur(message.author, message.channel, `Yazan Kişi: <@${data.sahip}>
  Mesaj: \`${data.icerik}\`
  Kanal: <#${data.kanal}>`, "RANDOM").sil(5)
