...
ModerationClient.guilds.cache.get(config.server).puanlog(yetkiliid, uye, puan, "chatmute", "puan-log")
    } else if(veritipi === "voicemute") {
pdb.add(`cezapuan.${uye.id}.${server}`, +10);
pdb.add(`cezasayi.${uye.id}.${server}`, +1);
let puan = pdb.get(`cezapuan.${uye.id}.${server}`);
ModerationClient.guilds.cache.get(config.server).puanlog(yetkiliid, uye, puan, "voicemute", "puan-log")
    } else if(veritipi === "jail") {
pdb.add(`cezapuan.${uye.id}.${server}`, +20);
pdb.add(`cezasayi.${uye.id}.${server}`, +1);
let puan = pdb.get(`cezapuan.${uye.id}.${server}`);
ModerationClient.guilds.cache.get(config.server).puanlog(yetkiliid, uye, puan, "jail", "puan-log")
    } else if(veritipi === "ban") {
pdb.add(`cezapuan.${uye.id}.${server}`, +60);
pdb.add(`cezasayi.${uye.id}.${server}`, +1);
let puan = pdb.get(`cezapuan.${uye.id}.${server}`);
ModerationClient.guilds.cache.get(config.server).puanlog(yetkiliid, uye, puan, "ban", "puan-log")
    } else if(veritipi === "warn") {
pdb.add(`cezapuan.${uye.id}.${server}`, +5);
pdb.add(`cezasayi.${uye.id}.${server}`, +1);
let puan = pdb.get(`cezapuan.${uye.id}.${server}`);
ModerationClient.guilds.cache.get(config.server).puanlog(yetkiliid, uye, puan, "warn", "puan-log")
    } 
}
...
module.exports = moderationFunctions;
