...
yetersizyaş:   `Belirtilen üyenin yaşı yaş sınırının (${registerConfig.minAge}) altında olduğu kayıt işlemi gerçekleştirilemiyor.`,
argümandoldur: "Tüm argümanları doldurunuz.",
taglıalım:     `Sunucumuz taglı alımda olduğu için belirtilen üyenin adında \`${config.tag}\` tagı bulunmadığı için kayıt işlemi gerçekleştirilemiyor.`,
